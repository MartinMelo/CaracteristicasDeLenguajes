...
\begin{align}
  ...
  & \to \fun y.(1+4)+4			 \label{fin-debil}\\
  & \to \fun y.~5+4			 \nonumber\\
  & \to \fun y.~9			 \label{fin-fuerte}\\
  & \to\fbox{9}				 \label{imposible}
\end{align}
El debil termina en el paso \eqref{fin-debil}. El fuerte termina en el \eqref{fin-fuerte}.

\section*{CBN fuerte y debil}
\begin{align}
  (\fun x.\fun y.(1+x)+4) ((\fun z.z*z)2)	\label{fin-debil2}
  & \to (\fun x.\fun y.(1+x)+4) (2*2)    \nonumber\\
  & \to (\fun x.\fun y.(1+x)+4) 4	 \nonumber\\
  & \to \fun y.(1+4)+4			 \nonumber\\
  & \to \fun y.~5+4			 \nonumber\\
  & \to \fun y.~9			 \label{fin-fuerte2}\\
  & \to\fbox{9}				 
\end{align}
El debil termina en el paso \eqref{fin-debil2}. El fuerte termina en el \eqref{fin-fuerte2}.
